...
* @api private
*/
router.get("/", _authMiddleware2.default, function () {
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _boardSchema.Board.find({ closed: false, idOrganization: req.user._id });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            id = req.params.id;
            _context2.next = 3;
            return _boardSchema.Board.findById({ _id: id }).populate([{
              path: "lists",
...
* @api private
*/
router.put("/:id", _authMiddleware2.default, function () {
    ...
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            _context3.next = 7;
            return _boardSchema.Board.findOneAndUpdate({ _id: id }, {
              name: name,
              bgPath: bgPath
            }, { new: true });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            id = req.body.id;
            _context4.next = 3;
            return _boardSchema.Board.findOneAndDelete({ _id: id });
    ...
    return _regenerator2.default.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 4:
            board = new _boardSchema.Board({ name: name, idOrganization: req.user._id, bgPath: bgPath });
            _context5.next = 7;
            return board.save();
